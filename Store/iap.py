"""Glyphstorm Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.asciimotion.pro"
NAME = "Glyphstorm Pro"
PRICE = "4.99"
DESCRIPTION = "No corner mark, 2x sharp, 15 second video exports."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free: every photo and video, all three styles, both "
    "sliders and export are free. Free exports carry a small GLYPHSTORM mark in the bottom right corner, "
    "render at screen resolution and stop videos at 5 seconds. Pro removes the mark, renders at twice the "
    "resolution and runs videos to 15 seconds. To see the paywall: tap GLYPHSTORM PRO at the bottom of the "
    "home screen, or open any photo and tap GO PRO under the EXPORT button. RESTORE PURCHASE is on the paywall."
)
